...
class CategoriasProdutoController extends Controller
{
    ...
    {
        return view('admin.admCategorias.cadastro');
    }
    ...
    {   
        ...
        CategoriaProduto::create([
            ...
            'imagem' => $request->titulo_categoria
        ]);

        return redirect()->route('admin.adm.admCategorias.index')->with('sucesso', 'Categoria cadastrada com sucesso!');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.adm.admCategorias.index')->with('sucesso', 'Usuário atualizado com sucesso!!!');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('admin.adm.admCategorias.index')->with('sucesso', 'Categoria deletada com sucesso!!!');
        } catch (\Exception $e) {
